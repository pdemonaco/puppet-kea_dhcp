...
Puppet::Type.type(:kea_ddns_server).provide(:json, parent: PuppetX::KeaDhcp::Provider::Json) do
  ...
  def self.instances
    ...
    [new(resource_hash(server, DEFAULT_CONFIG_PATH))]
  end
  ...
  def self.default_config
    { DDNS_KEY => { 'forward-ddns' => {}, 'reverse-ddns' => {} } }
  end
  ...
  def flush
    ...
    config[DDNS_KEY] ||= { 'forward-ddns' => {}, 'reverse-ddns' => {} }
  ...
  def config_path
    path = resource[:config_path] || DEFAULT_CONFIG_PATH
