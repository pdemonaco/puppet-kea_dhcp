  ...
  newproperty(:dhcp_ddns) do
    ...
    validate do |value|
      ...
      if normalized.key?('server-port')
        ...
        raise ArgumentError, 'server-port must be between 1 and 65_535' unless port.between?(1, 65_535)
      end
      ...
      if normalized.key?('sender-port')
        ...
        raise ArgumentError, 'sender-port must be between 0 and 65_535' unless port.between?(0, 65_535)
      end
